...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            String outputFileName = "outputCesar.txt";
            ...
            for (int i = 0 ; i < 10; i++) {
                ...
                while (scanner.hasNextLine()) {
                    ...
                    String encryptedLine = encrypt.encrypt(line, key);
                    originalText.append(encryptedLine).append(System.lineSeparator());
                }
                scanner.close();
            ...
            writer.write(originalText.toString());
            writer.close();
